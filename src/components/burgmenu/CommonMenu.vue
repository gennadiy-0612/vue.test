<template>
  <div id="MenuContent"
       class="MenuContent w-full h-full CommonMenu xl:pl-0 xl:pr-0 xl:h-auto xl:items-center hidden flex flex-wrap items-start justify-items-start absolute top-0 left-0 xl:m-auto bg-white xl:bg-opacity-0 xl:bg-white">

<template>
  <div class="CardPop2 MobHide CardInfoBack fixed bottom-0 left-0 top-0 bottom-0 h-full w-full flex justify-center items-center">
    <div class="CardInfoBanner CardInfoDeskTop fixed bg-white flex">
      <div class="CardInfo">
        <h3 class="CardInfo__para xl:font-semibold">Pop2 Пицца Филадельфия</h3>
        ...
        <router-link to="#" class="Pop2 closeLog-popup xl:block Ag-text14-to-1070 font-normal closeLog font-normal block router-link-active">Закрыть</router-link>
      </div>
